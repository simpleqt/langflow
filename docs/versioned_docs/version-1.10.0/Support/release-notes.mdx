...
- Redis-backed job queue for multi-worker deployments
    ...
    For setup instructions and configuration details, see [Deploy Langflow with multiple workers](../Deployment/deployment-multi-worker).
...
- Code Agents bundle (beta)
    ...
    For more information, see [Code Agents bundle](../Components/bundles-codeagents).
...
- File Processing bundle (beta)
    ...
    For more information, see [File Processing bundle](../Components/bundles-files-ingestion).
